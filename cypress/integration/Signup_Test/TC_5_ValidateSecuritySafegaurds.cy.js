...
describe('Validate The Landing Url Of Inline Security Safegaurd Link',()=>{
    ...
    it('First Remove Cookies And Validate The Landing Url Of Inline Security Safegaurd Link',()=>
    {
        ...
        hp.clickOnInlineHomePageBannerSecurityLink()


        cy.fixture('ProductionEnvironmentPath.json').then(penvUrl =>
            {
                        cy.url().should('eq', penvUrl.InlineHomePageBannerSecuritySafegaurdsUrl) // => true
